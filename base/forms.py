...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text = '<ul class="form-text text-muted small"><li>Acima de 8 caracteres</li><li>Sua senha não pode ser fácil.</li><li>Não pode ser apenas números</li></ul>'
